//create an array literal (best practice way)
...
//var firstElement = colorList.shift(); //removes the first element
//colorList.unshift("orange");
...
var imageListA = [];
//var imageListA = new Array(); //array constructor method
...
function onImageClick(evt)
{
	...
	// evt.target.setAttribute("class", "glow"); //set class to another class from css
	// evt.target.setAttribute("style", "display:none;");
	var imageIndex = imageListA.indexOf("images/drawing/thumbs/artwork_22.jpg");
